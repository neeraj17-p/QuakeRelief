      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
          ...
          <div className="space-y-2">
            <h4 className="text-[10px] font-semibold uppercase tracking-widest text-slate-400 mb-2">{t('quickReference')}</h4>
            <div className="grid grid-cols-1 gap-1.5 text-[11px]">
              <div className="flex items-center gap-2 text-slate-300">
                <MapPin className="h-3 w-3 text-red-400 shrink-0" />
                <span className="text-slate-400">{t('epicentre')}</span>
                <span className="font-mono text-white">18.0700°N, 76.6200°E (Killari, Latur)</span>
              </div>
              <div className="flex items-center gap-2 text-slate-300">
                <Zap className="h-3 w-3 text-orange-400 shrink-0" />
                <span className="text-slate-400">{t('magnitudeLabel')}</span>
                <span className="font-mono text-white">M6.2</span>
                <span className="text-slate-600">|</span>
                <span className="text-slate-400">{t('depthLabel')}</span>
                <span className="font-mono text-white">15km</span>
              </div>
              <div className="flex items-start gap-2 text-slate-300">
                <Clock className="h-3 w-3 text-sky-400 shrink-0 mt-0.5" />
                <span className="text-slate-400 shrink-0">{t('sources')}</span>
                <span className="text-slate-300">{t('sourcesList')}</span>
              </div>
              <div className="flex items-center gap-2 text-slate-300">
          ...
          <div className="space-y-2">
            <h4 className="text-[10px] font-semibold uppercase tracking-widest text-slate-400 mb-2">{t('emergencyContactsTitle')}</h4>
            <div className="space-y-1.5 text-[11px]">
              ...
              <div className="flex items-center justify-between gap-2">
                <span className="text-slate-400">{t('districtControl')}</span>
              ...
              <Button
                ...
                onClick={() => toast.info(t('emergencyHotline'), { description: t('emergencyHotlineDesc') })}
              >
