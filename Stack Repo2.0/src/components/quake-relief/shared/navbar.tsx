...
export default function QuakeReliefNavbar() {
  ...
  const ROLES: RoleItem[] = useMemo(() => [
    { key: 'public', label: t('publicPortal'), icon: Globe, desc: t('citizenSafety'), color: 'text-emerald-600 dark:text-emerald-400' },
    { key: 'rescue', label: t('rescuePortal'), icon: Shield, desc: t('fieldOps'), color: 'text-amber-600 dark:text-amber-400' },
    { key: 'admin', label: t('commandCentre'), icon: Terminal, desc: t('eocAdmin'), color: 'text-red-600 dark:text-red-400' },
  ], [t])
        ...
        <div className="flex items-center justify-between px-4 py-2.5">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[10px] text-slate-400 leading-none mt-0.5">{t('multiAgentDisaster')}</p>
            </div>
          </div>
